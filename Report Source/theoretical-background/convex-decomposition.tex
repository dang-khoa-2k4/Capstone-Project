...
\begin{itemize}
    \item \textbf{Hiệu quả tính toán cao hơn:} Các thuật toán ACD, chẳng hạn như phương pháp của Lien và Amato, chạy nhanh hơn nhiều so với ECD. \cite{LienAmato2006}
    \item \textbf{Giảm mạnh số lượng vùng:} Cho phép biểu diễn hình dạng với ít vùng lồi hơn, đơn giản hơn và dễ xử lý hơn.
    \item \textbf{Kiểm soát mức độ chi tiết:} Một số thuật toán ACD như phương pháp của Lien và Amatocho phép người dùng điều chỉnh tham số lõm $\tau$ để cân bằng giữa độ chính xác và số lượng vùng lồi. Hay đối với phương pháp Visibility Clique Cover (VCC), nó cho phép người dùng chọn chỉ số để thể hiện mức độ bao phủ của vùng lồi so với không gian tự do ban đầu. \cite{DeitsTedrake2023VCC}
\end{itemize}  
