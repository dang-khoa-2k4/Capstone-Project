...
Tối ưu hóa nguyên-hỗn hợp là nền tảng tính toán của các kỹ thuật được giới thiệu trong luận văn này.
...
Hai nguồn tham khảo quan trọng cho tất cả các chi tiết về tối ưu hóa nguyên-hỗn hợp là cuốn sách
cổ điển~\cite{wolsey1999} và cuốn sách gần đây hơn~\cite{conforti2014}.
...
Dưới đây chúng ta định nghĩa các lớp MIP quan trọng nhất trong phạm vi luận văn này.
...
\]
Tất cả các MIP mà chúng ta sẽ gặp trong luận văn này thực ra đều là các MBP.
