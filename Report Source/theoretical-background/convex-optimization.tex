...
\begin{figure}[h]
    ...
    \caption{Examples of simple convex and nonconvex sets. Left: The hexagon, including its boundary, is convex. Middle: The kidney-shaped set is nonconvex, as the line segment connecting the two points lies outside the set. Right: The square contains some boundary points but not others, and is therefore not convex.\cite{boyd2004}}
...
\begin{figure}[h]
    ...
    \caption{Convex hull of a set of points (shaded area).\cite{boyd2004}}
