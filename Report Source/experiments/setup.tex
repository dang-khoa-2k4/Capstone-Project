...
\textbf{Mục tiêu:}
Định lượng sự tác động của các thuật toán phân hoạch lồi khác nhau (ACD, VCC) so với phương pháp phân hoạch thủ công\footnote{Ở đây chúng tôi giả sử kết quả từ phân hoạch thủ công là kết quả tốt nhất để từ đó so sánh mức độ hiệu quả của các giải thuật còn lại.} (Manual) lên hiệu suất của bộ lập kế hoạch GCS.\\

\textbf{Mô tả kịch bản:}
\begin{itemize}
    \item Thiết lập một không gian làm việc 2D với các vật cản đa giác lồi được bố trí cố định.
    \item Thực hiện phân hoạch không gian tự do bằng ba phương pháp:
    \begin{itemize}
        \item \textbf{Phân hoạch Thủ công (Ground-truth):} Tạo ra số lượng vùng lồi tối thiểu bằng sự can thiệp của con người để làm chuẩn đối sánh.
        \item \textbf{Phân hoạch Lồi Xấp xỉ (ACD):} Sử dụng thuật toán của Lien và Amato với mức dung sai $\tau = 0.0$ (tức các vùng lồi được tạo ra hoàn toàn lồi).
        \item \textbf{Lớp phủ Clique Khả kiến (VCC):} Sử dụng phương pháp xây dựng đồ thị khả kiến và tìm lớp phủ clique để tự động hóa việc đặt điểm mầm cho IRIS với mức độ phủ $96\%$.
    \end{itemize}
\end{itemize}
...
\textbf{Mô tả kịch bản:}
\begin{itemize}
    \item \textbf{Cấu trúc môi trường:} Mê cung kích thước $25 \times 25 = 625$ ô, sinh bằng thuật toán DFS ngẫu nhiên và loại bỏ ngẫu nhiên 100 bức tường.
    \item \textbf{Thiết lập GCS:} Mỗi ô được mô hình hóa thành một tập an toàn lồi $Q_i$ với các cạnh hai chiều giữa các ô kề nhau.
\end{itemize}
