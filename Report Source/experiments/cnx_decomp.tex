...
Để giải quyết thách thức tính toán của bước phân hoạch, một số phương pháp đã được phát triển. Dưới đây là ba phương pháp được sử dụng trong luận văn này:
