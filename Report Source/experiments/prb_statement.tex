...
Phần này xây dựng mô hình toán học tổng quát làm nền tảng chung cho cả hai hướng
tiếp cận được trình bày trong Phần~\ref{sec:gcs_approach}
và Phần~\ref{sec:ocp_dms_approach}.
...
\textbf{Hướng tiếp cận OCP-DMS} (Phần~\ref{sec:ocp_dms_approach}) mô hình hóa
