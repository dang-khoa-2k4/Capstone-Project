...
\begin{aligned}
    ...
    & & & \mathbf{x}(t) \in \mathcal{C}_{\text{free}}^{\mu}, \quad \forall t \in [0, T], \\
    & & & T_{\min} \leq T \leq T_{\max}.
\end{aligned}
\end{equation}

Trong đó, ràng buộc đầu và cuối đảm bảo quỹ đạo bắt đầu và kết thúc tại các vị trí xác định. Ràng buộc không gian trạng thái yêu cầu quỹ đạo phải nằm trong không gian tự do $\mathcal{C}_{\text{free}}^{\mu}$, được định nghĩa là không gian khả vi $\mu$ lần. Cuối cùng, ràng buộc về thời gian đảm bảo quỹ đạo được hoàn thành trong khoảng thời gian hợp lý.
