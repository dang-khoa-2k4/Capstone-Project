...
Để khắc phục tính phi lồi tự nhiên của không gian có vật cản, bài toán hoạch định chuyển động thường được phát biểu dưới dạng Bài toán Điều khiển Tối ưu (Optimal Control Problem).
