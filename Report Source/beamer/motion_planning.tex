...
\begin{frame}{Thiết lập thực nghiệm}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{0.24\textwidth}
            \raggedright
            {\scriptsize\textbf{TN4 -- 2D đơn giản}}\\[-0.15em]
...
% =====================================================================
\begin{frame}{TN4 - Ba phương pháp phân hoạch lồi (đầu vào)}
    \centering
...
% =====================================================================
\begin{frame}{TN4 - Tác động lên GCS-Bézier}
    \begin{columns}[T,onlytextwidth]
        \begin{column}{0.46\textwidth}
            \centering
...
% =====================================================================
\begin{frame}{TN4 - Tác động lên GCS-DMS (Unicycle)}
    \vspace{-0.55em}
