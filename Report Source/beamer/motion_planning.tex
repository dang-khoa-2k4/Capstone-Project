...
\begin{frame}{TN3 - Đánh đổi giữa GCS và sampling-based}
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{0.42\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Độ trơn:} GCS-Linear $22.6 \ll$ RRT/RRT* $\sim\!60$ kể cả sau shortcut $\Rightarrow$ sampling vẫn gấp khúc.
            \end{itemize}
        \end{column}
    \end{columns}
    ...
    \begin{center}
        ...
        \begin{tabular}{@{}lcccc@{}}
            \toprule
                       & \textbf{Length} & \textbf{Runtime (ms)} & \textbf{Acc. angle} & \textbf{Std runtime} \\
            \midrule
