...
\begin{frame}{Hoạch định chuyển động trong GCS}
    \begin{columns}[T,onlytextwidth]
...
\begin{frame}{Tiếp cận 2: Kết hợp GCS với Direct Multiple Shooting (DMS) - MIOCP/MINLP}
    \small
...
% =====================================================================
% TN3 - Slide 1: GCS vs RRT/RRT* setup + results table
% =====================================================================
\begin{frame}{TN3 - GCS vs RRT/RRT* trên mê cung $25\!\times\!25$ (seed 4)}
    \vspace{-0.6em}
    \begin{columns}[T,onlytextwidth]
        \begin{column}{0.46\textwidth}
            \centering
