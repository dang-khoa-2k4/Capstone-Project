...
\begin{frame}{Phương pháp 2: Kết hợp GCS với Direct Multiple Shooting (GCS-DMS)}
    ...
    Hệ động lực học:\quad $\dot{x}(t)=f\bigl(x(t),u(t)\bigr)$,\quad $t\in[0,T]$
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{0.37\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Defect} $\sim 10^{-14}$: sai số động lực học trong mỗi đoạn shooting
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{0.4\textwidth}
            ...
            \begin{itemize}\itemsep0pt
                \item Sai số động lực học nội đoạn (Defect) $\sim 10^{-10}$
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Đã đề xuất được một cách thiết lập bài toán điều khiển tối ưu sử dụng mô hình GCS
                      để giải quyết bài toán hoạch định chuyển động với động lực phi tuyến.
