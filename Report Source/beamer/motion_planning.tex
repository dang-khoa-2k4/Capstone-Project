    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{0.42\textwidth}
            ...
            \begin{itemize}
                ...
                \item \textbf{Tổng góc đổi hướng:} GCS-Linear $22.6 \ll$ RRT/RRT* $\sim\!60$ kể cả sau shortcut $\Rightarrow$ sampling vẫn gấp khúc.
            \end{itemize}
        \end{column}
    \end{columns}
...
% =====================================================================
\begin{frame}{TN4 - Biểu đồ vận tốc: tự độngStrong at researching and implementing ML/DL pipelines (especially Computer Vision) and mathematical foundations (especially Probability & Statistics) giảm tốc tại nút giao và hành lang hẹp}
    \begin{columns}[T,onlytextwidth]
        \begin{column}{0.58\textwidth}
            \centering
            \begin{minipage}{0.48\linewidth}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{itemize}
                ...
                \item Đã đề xuất được một cách thiết lập bài toán điều khiển tối ưu sử dụng mô hình GCS
                      để giải quyết bài toán hoạch định chuyển động với động phi tuyến.
