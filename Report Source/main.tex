...
\centering
{\Large \bfseries \MakeUppercase{Motion Planning around Obstacles}}\\     
...
\begin{tabular}[H]{r l l}
     \large \textbf{THESIS COMMITTEE} &: \large COMPUTER ENGINEERING\\
     \large \textbf{SUPERVISOR(s)} & : \large LE HONG TRANG, Assoc. Prof \\
                                    & : \large \\
    %  \large \textbf{REVIEWER} & : \large VO THANH HUNG, M.Eng.\\
     \multicolumn{2}{c}{\textbf{\large ————o0o———–}}\\
     \large \textbf{STUDENT}& : NGUYEN TRAN DANG KHOA - 2211635\\
                            & : HO DANG KHOA - 2211 \\ 
...
\vspace{1.cm}
\begin{center}
{\fontsize{12pt}{0pt} HO CHI MINH CITY, November 2025}
\end{center}
\end{titlepage}
