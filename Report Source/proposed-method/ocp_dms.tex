...
Trong thực thi, bài toán MINLP tổng hợp~\eqref{eq:joint_obj}--\eqref{eq:joint_binary} được xây dựng bằng CasADi~\cite{Andersson2019} và giải bằng IPOPT.
...
Để đưa bài toán về dạng NLP thuần túy có thể tiếp nhận bởi IPOPT, ràng buộc nhị phân~\eqref{eq:joint_binary} được thay thế bằng ràng buộc liên tục:
\begin{equation}
    y_{uv} \in \{0,1\}
    \;\longrightarrow\;
    y_{uv} \in [0,1],
